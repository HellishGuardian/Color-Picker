...
function randomColors() {
  ...
  //   Reset inputs
  resetIputs();
  // Check for contrast for buttons
  adjustBtn.forEach((btn, index) => {
...
const sunmitSave = document.querySelector(".submit-save");
